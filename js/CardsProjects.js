...
const Projects = [

    {
        ...
        descricao: 'Uma rede social direcionado para comunidade devs com o objetivo de fazer a conexão de pessoas que vivem nessa imersão tão incrível que é o desenvolvimento de sistemas. Feito com diferentes tipos de funcionalidades que só a nossa plataforma DevInt tem!, como o compartilhamento de projetos, iteração com Github, e muito mais.',
        pagina: '',
